...
clip gages to HUC4 boundaries and project (to NAD Albers 1983) and select streams by selecting
only "Connector", "CanalDitch", "StreamRiver" and "ArtificialPath" type of NHDFlowlines in FType
"""
import arcpy
import os
import pandas as pd
